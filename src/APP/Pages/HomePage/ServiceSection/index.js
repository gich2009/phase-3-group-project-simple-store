    ...
    <>
      ...
      <div className="container">
        <div className="column">
          <img src={MoneyImage} alt="Image 1" className="rounded-image" />
          <h3>Sales</h3>
          <p>Make and track your sales simply and quickly on your profile</p>
        </div>
        <div className="column">
          <img src={MoneyToyImage} alt="Image 2" className="rounded-image" />
          <h3>Inventory</h3>
        ...
        <div className="column">
          <img src={PartnershipImage} alt="Image 3" className="rounded-image" />
          <h3>Suppliers</h3>
          <p>Track your main suppliers for each of your products</p>
        </div>
        <div className="column">
          <img src={StoreImage} alt="Image 4" className="rounded-image" />
          <h3>Consolidation </h3>
